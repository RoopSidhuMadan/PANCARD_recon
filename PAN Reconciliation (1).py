...
def main():
    ...
    #---------------------------------------------------------------------------------------------------------------------
        ...
        df.to_gbq(destination_table='sm_recon.ts_pan_card_payment_report_log', project_id='spicemoney-dwh', if_exists='replace' , table_schema = schema,credentials=credentials)
        print("Data moved to ts_pan_card_payment_report_log table")
        df.to_gbq(destination_table='prod_sm_recon.prod_pan_card_payment_report_log', project_id='spicemoney-dwh', if_exists='append' , table_schema = schema,credentials=credentials)
        ...
        df_csf.to_gbq(destination_table='sm_recon.ts_pan_card_csf_payment_report_log', project_id='spicemoney-dwh', if_exists='replace' , table_schema = schema_csf,credentials=credentials)
        print("Data moved to ts_pan_card_csf_payment_report_log table")
        df.to_gbq(destination_table='prod_sm_recon.prod_pan_card_csf_payment_report_log', project_id='spicemoney-dwh', if_exists='append' , table_schema = schema_csf,credentials=credentials)
        ...
        df_csf1.to_gbq(destination_table='sm_recon.ts_pan_card_csf_payment_report_1_log', project_id='spicemoney-dwh', if_exists='replace' , table_schema = schema_csf1,credentials=credentials)
        print("Data moved to ts_pan_card_csf_payment_report_1_log table")
        df.to_gbq(destination_table='prod_sm_recon.prod_pan_card_csf_payment_report_1_log', project_id='spicemoney-dwh', if_exists='append' , table_schema = schema_csf1,credentials=credentials)
        ...
        df1.to_gbq(destination_table='sm_recon.ts_pan_card_payment_report_1_log', project_id='spicemoney-dwh', if_exists='replace' , table_schema = schema1,credentials=credentials)
        print("Data moved to ts_pan_card_payment_report_1_log table")
        df.to_gbq(destination_table='prod_sm_recon.prod_pan_card_payment_report_1_log', project_id='spicemoney-dwh', if_exists='append' , table_schema = schema1,credentials=credentials)
